	...
	<el-card class="box-card">
			...
			<div class="card-header">
				<el-form inline>
					<el-form-item label="角色名称">
						<el-input v-model="searchOpt.roleName" placeholder="请输入角色名称"></el-input>
					</el-form-item>
					<el-form-item label="角色标识">
						<el-input v-model="searchOpt.roleKey" placeholder="请输入角色标识"></el-input>
					</el-form-item>
					<el-form-item>
						<el-button type="primary" class="button" @click="getRoleList()">查询</el-button>
						<el-button @click="resetHandler">重置</el-button>
						<el-button type="primary" @click="openModifyDialog">新增角色</el-button>
					</el-form-item>
				</el-form>
			</div>
		</template>
		<el-table :data="roleList">
			...
			<el-table-column label="操作">
				<template #default="{ row }">
					<el-button type="primary" @click="openModifyDialog(row)">编辑</el-button>
					<el-button @click="openDetailDialog(row)">详情</el-button>
					<el-button type="danger" @click="delRoleInfo(row.roleId)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		<el-pagination layout="prev, pager, next, jumper, ->, sizes, total" :total="total" :background="true"
			:page-sizes="[10, 20, 50, 100]" v-model:current-page="searchOpt.pageNum"
			v-model:page-size="searchOpt.pageSize" @current-change="getRoleList" @size-change="getRoleList()" />
...
const modifyRef = ref<{ opendialog: (roleInfo: Role | null) => void } | null>(null)
